...
export const PROJECTS = [
    ...
    },
    {
        ...
        summary: 'Real-Time AI Data Agent: Upload a CSV - Talk to your live Analyst. Streams live graphs, voice results, and transcripts. Runs complex tasks—like stance annotation—updating Google Sheets in real time.\n \n 1st place, Berlin AI Hackathon.',
    ...
    {
        id: 'flutter-onnx',
        title: 'Flutter ONNX Image Classification',
...
export const PAPERS = [
    {
        ...
        id: 'paper2',
        title: 'On-the-Fly Calculation of Model Factors for Multi-paradigm Applications',
        authors: 'Protze, Orland, Haldar, Koritzius, Terboven',
        year: 2022,
        summary: 'Originating from my bachelor thesis, introduces a tool to accurately separate and quantify model factors in layered parallel programming paradigms for Hybrid MPI+OpenMP metric, providing deeper insights into sources of inefficiency—such as load imbalance and synchronization overhead—across applications with various concurrency patterns.',
        link: 'https://doi.org/10.1007/978-3-031-12597-3_5'
    }]
